...
abstract class BaseTermRelationship extends BaseObject  implements Persistent {
  ...
  const PEER = 'TermRelationshipPeer';
	...
	/**
	 * Initializes internal state of BaseTermRelationship object.
	 * @see        applyDefaults()
	 */
	...
	public function setPluginId($v)
	{
		...
		if ($this->plugin_id !== $v) {
			$this->plugin_id = $v;
			$this->modifiedColumns[] = TermRelationshipPeer::PLUGIN_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = TermRelationshipPeer::NUM_COLUMNS - TermRelationshipPeer::NUM_LAZY_LOAD_COLUMNS).
    ...
    foreach (sfMixer::getCallables('BaseTermRelationship:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			TermRelationshipPeer::doDelete($this, $con);
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = TermRelationshipPeer::doInsert($this, $con);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TermRelationshipPeer::PLUGIN_ID)) $criteria->add(TermRelationshipPeer::PLUGIN_ID, $this->plugin_id);
	...
	public function getPlugin(PropelPDO $con = null)
	{
		if ($this->aPlugin === null && ($this->plugin_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aPlugin->addTermRelationships($this);
			 */
		}
		return $this->aPlugin;
	}
	...
	public function getTerm(PropelPDO $con = null)
	{
		if ($this->aTerm === null && ($this->term_id !== null)) {
			...
			$c->add(TermPeer::ID, $this->term_id);
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseTermRelationship:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseTermRelationship::%s', $method));
    }
